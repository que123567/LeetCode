 ...
 * Output:
 * [-8,-3,-7,-4,-2,-6,0,-9,-2,-8,-7,-3,-2,-1,-5,-7,-9,-6,-2]
 * Expected:
...
public class LeetCode455_1
{
    ...
    static class Solution
    {
        public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
            long num1 = ListToArray(l1);
            long num2 = ListToArray(l2);
            num1 += num2;
            return ArrayToList(num1);
        }
    }

    static long ListToArray(ListNode list) {
        long tmpArray = 0;
        while (list != null) {
    ...
    static ListNode ArrayToList(long array) {
        //1236-> 6-3-2-1
        // ------ 1->2->3->6
